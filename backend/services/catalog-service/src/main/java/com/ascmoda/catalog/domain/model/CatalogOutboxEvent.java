...
@Entity
@Table(
        name = "catalog_outbox_events",
        indexes = {
                @Index(name = "idx_catalog_outbox_status_occurred_at", columnList = "status,occurred_at"),
                ...
                @Index(name = "idx_catalog_outbox_event_type", columnList = "event_type"),
                @Index(name = "idx_catalog_outbox_correlation_id", columnList = "correlation_id")
        }
)
public class CatalogOutboxEvent {
    ...
    public CatalogOutboxEvent(UUID id, String aggregateType, String aggregateId, String eventType, String payloadJson,
